...
## 1. Master Prompt (verbatim)

*Paste the full MASTER PROMPT from the initial session here to preserve the rules, build order, and specs across tool switches.*
...
| JWT_ISSUER | ai-pr-reviewer | JWT issuer claim | Auth |
